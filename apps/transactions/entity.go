...
// subtotal dan grandtotal harus di tangani di bagian backend
// jangan di handle dibagian frontend karena data nya bisa dimanipulasi

// disini menggunakan pointer karena melakukan set data.
// setter adalah metode untuk memanipulasi data
...
// untuk metode get tidak perlu pointer
